...
void TriggerServerRPCAnswer(u16 answerID, MValueMutWrapper args, const StdStringClone error) {
    return alt::ICore::Instance().TriggerServerRPCAnswer(answerID, args.ptr, error);
}
...
alt::ICheckpoint* CreateCheckpoint(u8 type, f32 pos_x, f32 pos_y, f32 pos_z, f32 next_x, f32 next_y, f32 next_z, f32 radius, f32 height, u8 color_r, u8 color_g, u8 color_b, u8 color_a, u8 iconColor_r, u8 iconColor_g, u8 iconColor_b, u8 iconColor_a, u32 streamingDistance, alt::IResource* res) {
    return alt::ICore::Instance().CreateCheckpoint(type, { pos_x, pos_y, pos_z }, { next_x, next_y, next_z }, radius, height, { color_r, color_g, color_b, color_a }, { iconColor_r, iconColor_g, iconColor_b, iconColor_a }, streamingDistance, res);
}
...
void ResetMinimapComponentPosition(const StdStringClone name) {
    return alt::ICore::Instance().ResetMinimapComponentPosition(name);
}
