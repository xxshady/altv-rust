...
impl player::Player {
  ...
  pub fn is_in_water(&self) -> SomeResult<bool> {
  ...
  pub fn has_weapon_component(
    ...
    Ok(unsafe {
      sdk::IPlayer::HasWeaponComponent(self.raw_ptr()?, weapon.into_hash(), component.into_hash())
    })
  }
  ...
  pub fn add_weapon_component(
    ...
    unsafe {
      sdk::IPlayer::AddWeaponComponent(self.raw_ptr()?, weapon.into_hash(), component.into_hash())
    }
    Ok(())
  }
  ...
  pub fn get_clothes(&self, component: u8) -> SomeResult<structs::PlayerCloth> {
    let raw = unsafe { sdk::IPlayer::GetClothes(self.raw_ptr()?, component) }.within_unique_ptr();
  ...
  pub fn set_clothes(
    ...
    Ok(unsafe { sdk::IPlayer::SetClothes(self.raw_ptr()?, component, drawable, texture, palette) })
  }
  ...
  pub fn get_dlc_prop(&self, component: u8) -> SomeResult<structs::PlayerDlcProp> {
    let raw = unsafe { sdk::IPlayer::GetDlcProps(self.raw_ptr()?, component) }.within_unique_ptr();

    let (mut drawable, mut texture, mut dlc) = Default::default();
    unsafe { sdk::read_alt_dlc_prop(raw.as_ref().unwrap(), &mut drawable, &mut texture, &mut dlc) }
  ...
  pub fn get_head_overlay(&self, overlay_id: u8) -> SomeResult<structs::PlayerHeadOverlay> {
    let raw =
      unsafe { sdk::IPlayer::GetHeadOverlay(self.raw_ptr()?, overlay_id) }.within_unique_ptr();
  ...
  pub fn set_head_blend_palette_color(
    ...
    Ok(unsafe { sdk::IPlayer::SetHeadBlendPaletteColor(self.raw_ptr()?, id, red, green, blue) })
  }

  pub fn get_head_blend_palette_color(&self, id: u8) -> SomeResult<Rgba> {
    Ok(helpers::read_cpp_rgba(
      unsafe { sdk::IPlayer::GetHeadBlendPaletteColor(self.raw_ptr()?, id) }.within_unique_ptr(),
    ))
  }
  ...
  pub fn streamed_entities(&self) -> SomeResult<Vec<(AnyEntity, SquaredDistance)>> {
    ...
    for e in raw_entities.into_iter() {
      let entity = {
        ...
        let entity = Resource::with(|resource| helpers::get_entity_by_ptr(raw_ptr, resource));
        match entity {
          Some(e) => e,
          None => {
  ...
  pub fn get_ammo_special_type(
    ...
    let raw =
      unsafe { sdk::IPlayer::GetAmmoSpecialType(self.raw_ptr()?, ammo_type_hash.into_hash()) };
  ...
  pub fn get_ammo_flags(&self, ammo_type_hash: impl IntoHash) -> SomeResult<structs::AmmoFlags> {
    let ptr = unsafe { sdk::IPlayer::GetAmmoFlags(self.raw_ptr()?, ammo_type_hash.into_hash()) }
      .within_unique_ptr();
  ...
  pub fn remove_decoration(&self, collection: impl IntoHash, overlay: impl IntoHash) -> VoidResult {
    unsafe {
      sdk::IPlayer::RemoveDecoration(self.raw_ptr()?, collection.into_hash(), overlay.into_hash())
    }
    Ok(())
  }
  ...
  pub fn cloud_auth_result(&self) -> SomeResult<altv_sdk::CloudAuthResult> {
    Ok(
      altv_sdk::CloudAuthResult::try_from(unsafe {
