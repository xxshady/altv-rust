...
impl vehicle::Vehicle {
  ...
  pub fn set_primary_color_rgb(&self, color: impl Into<Rgba>) -> VoidResult {
    ...
    unsafe {
      sdk::IVehicle::SetPrimaryColorRGB(self.raw_ptr()?, color.r(), color.g(), color.b(), color.a())
    }
    Ok(())
  }
  ...
  pub fn set_tire_smoke_color(&self, color: impl Into<Rgba>) -> VoidResult {
    let color: Rgba = color.into();
    unsafe {
      sdk::IVehicle::SetTireSmokeColor(self.raw_ptr()?, color.r(), color.g(), color.b(), color.a())
    }
    Ok(())
  }
  ...
  pub fn set_timed_explosion(
    ...
    unsafe { sdk::IVehicle::SetTimedExplosion(self.raw_ptr()?, state, culprit.raw_ptr()?, time) }
    Ok(())
  }
  ...
  pub fn set_quaternion(&self, quaternion: impl Into<Quaternion>) -> VoidResult {
    ...
    unsafe { sdk::IVehicle::SetQuaternion(self.raw_ptr()?, quat.x(), quat.y(), quat.z(), quat.w()) }
    Ok(())
  }
